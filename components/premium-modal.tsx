                ...
                <ScrollArea className="h-full max-h-[90vh]">
                    <div className="p-6 sm:p-8">
                        <DialogHeader className="mb-8 text-center">
                            <DialogTitle className="text-3xl font-extrabold tracking-tight sm:text-4xl bg-gradient-to-r from-amber-400 to-orange-600 bg-clip-text text-transparent pb-2">
                                Mejora tu experiencia
                            </DialogTitle>
                            <DialogDescription className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                                Desbloquea todo el potencial de AquaGuard con nuestros planes premium.
                            </DialogDescription>
                        </DialogHeader>

                        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto pb-8">
                            {/* Monthly Plan */}
